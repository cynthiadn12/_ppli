...
=======
                <form method="POST" action="{{ route('user-management.search') }}">
                    ...
                    @component('layouts.two-cols-search-row', ['items' => ['NRP', 'Name'],
                    'oldVals' => [isset($searchingVals) ? $searchingVals['nrp'] : '', isset($searchingVals) ? $searchingVals['name'] : '']])
                    @endcomponent
                    </br>
                    @component('layouts.two-cols-search-row', ['items' => ['Email', 'Level'],
                    'oldVals' => [isset($searchingVals) ? $searchingVals['email'] : '', isset($searchingVals) ? $searchingVals['level'] : '']])
                    @endcomponent
                    @endcomponent
                </form>
